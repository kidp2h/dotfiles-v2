			...
			callback = function()
				...
				if isTransparent then
					...
					vim.api.nvim_set_hl(
						0,
						"TelescopeTitle",
						{ bg = colors.purple, fg = colors.fg, underline = false, bold = true }
					)
				...
				vim.api.nvim_set_hl(0, "TelescopePromptPrefix", { bg = colors.white3, fg = colors.red })
				vim.api.nvim_set_hl(0, "TelescopePromptBorder", { bg = colors.white3, fg = colors.white3 })
				vim.api.nvim_set_hl(0, "TelescopePromptNormal", { bg = colors.white3, fg = colors.red })

				vim.api.nvim_set_hl(0, "TelescopePromptTitle", { bg = colors.red, fg = colors.white })
				vim.api.nvim_set_hl(0, "TelescopeSelection", { bg = colors.red, fg = colors.white })

				vim.api.nvim_set_hl(0, "TelescopeBorder", { bg = colors.white1, fg = colors.white1 })
				vim.api.nvim_set_hl(0, "TelescopeNormal", { bg = colors.white1, fg = colors.fg })

				vim.api.nvim_set_hl(0, "TelescopePreviewTitle", { bg = colors.red, fg = colors.white, bold = true })
				vim.api.nvim_set_hl(0, "TelescopePreviewBorder", { bg = colors.white2, fg = colors.white2 })
				vim.api.nvim_set_hl(0, "TelescopePreviewNormal", { bg = colors.white2 })

				vim.api.nvim_set_hl(0, "LspInlayHint", { link = "@comment.info" })
				...
				vim.api.nvim_set_hl(0, "Markview_dark", { bg = colors.white })
				vim.api.nvim_set_hl(0, "NoiceCmdlinePopupBorder", { bg = colors.white2, fg = colors.white2 })
				vim.api.nvim_set_hl(0, "NoiceCmdlinePopupBorderSearch", { bg = colors.white2, fg = colors.white2 })

				vim.api.nvim_set_hl(0, "NoiceCmdlinePopupTitleCmdline", { bg = colors.blue, fg = colors.white })
				vim.api.nvim_set_hl(0, "NoiceCmdlinePopupTitleSearch", { bg = colors.yellow, fg = colors.white })
				vim.api.nvim_set_hl(0, "NoiceCmdlinePopupTitleLua", { bg = colors.cyan, fg = colors.white })
				vim.api.nvim_set_hl(0, "NoiceCmdlineIconLua", { bg = colors.white2, fg = colors.cyan })
				vim.api.nvim_set_hl(0, "NoiceCmdlinePopup", { bg = colors.blue, fg = colors.white })
				vim.api.nvim_set_hl(0, "FloatBorder", { bg = colors.white2, fg = colors.white2 })
				vim.api.nvim_set_hl(0, "FloatTitle", { bg = colors.red, fg = colors.white })
				vim.api.nvim_set_hl(0, "RenameNormal", { bg = colors.white2, fg = colors.red })
				vim.api.nvim_set_hl(0, "SagaTitle", { bg = colors.red, fg = colors.white })
				vim.api.nvim_set_hl(0, "SagaActionTitle", { bg = colors.red, fg = colors.white })
				vim.api.nvim_set_hl(0, "SagaButton", { bg = colors.white2, fg = colors.red })
				vim.api.nvim_set_hl(0, "NeoTreeFloatTitle", { bg = colors.red2, fg = colors.white })
				vim.api.nvim_set_hl(0, "WhichKeyIcon", { underline = false, bg = colors.white2, fg = colors.red })
			end,
		},
	},
}
